...
<!-- 		<tr>
			<th>Current table prefix</th>
			<td>
				<?php echo dbs_get_table_prefix() ?>
			</td>
		</tr>
		<tr>
			<th>Target table prefix</th>
			<td>
				<input type="input" size="10" name="target_prefix" value="<?php echo dbs_get_target_table_prefix() ?>">
			</td>
		</tr>
 -->		<tr valign="top">
